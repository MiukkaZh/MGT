...
class TruncatedInputfromMFB(object):
    ...
    def __init__(self, opts, input_per_file=1):
    ...
    def __call__(self, frames_features):
        ...
        win_size = self.opts['num_win_size']
        ...
        for i in range(self.input_per_file):
            j = random.randrange(0, num_frames - win_size)
            frames_slice = frames_features[j:j + win_size]
